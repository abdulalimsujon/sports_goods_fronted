    ...
    <div className=" h-screen max-w-[1580px] mx-auto mt-10 ">
      <div className="container   max-w-[1580px] ">
        <div className="grid grid-cols-12 ">
          <div className="lg:col-span-3  relative md:col-span-12 sm:col-span-12">
            <div className="fixed z-50">
              ...
              >
                ...
                <div
                  className={`absolute left-0 top-full  w-48 bg-white border border-gray-300 rounded-lg shadow-lg transition-opacity duration-300 ${
                  ...
                  <ul className="space-y-2">
                    ...
                    >
                      ...
                      {activeSubMenu === "category" && (
                        <ul className="absolute left-full top-0  w-48 bg-white border border-gray-300 rounded-lg shadow-lg space-y-2 z-20">
            ...
            <div className="ml-0 mt-80  fixed">
              <RangeSlider></RangeSlider>
            </div>
          </div>
          <div className="lg:col-span-9 flex justify-between md:col-span-12 sm:col-span-12">
            <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1 gap-2 max-w-[1680px]">
